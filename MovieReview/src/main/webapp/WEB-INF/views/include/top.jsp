...
<body>
	<div id = "header_cont">
		...
		<input type = "hidden" value = "title" name = "label">
			<div id = "header_search">
				<img src="${path }/resources/img/logo3.png">
				<input type = "text" class= "search_txt" name = "search" placeholder="영화제목을 입력해주세요"><input type = "button" class="search_btn" value="검색">
			</div>
		</form>
		<div id = "header_main">
			<table>
