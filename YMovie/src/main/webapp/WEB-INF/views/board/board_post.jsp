...
<script type="text/javascript">
	...
	function comm(data){
		...
		for(i in data.comm){
			...
			tb += "<td rowspan = '2' class = 'img_td'><img src='${pageContext.request.contextPath }/resources/img"+data.comm[i].mem_img+"'></td>";
	...
	<div id = "content">
		<div id = "board_post">
			<div id = "b_cont">
				...
				<p id = "mem_info"><img id = "info_img" src="${path }/resources/img${board.getMem().getMem_img() }"> ${board.getBoard_writer() }<span class="mem">${board.getBoard_regdate() }</span><span class="mem">조회수 : ${board.getBoard_hit() }</span></p>
			...
			<div id = "comment_box">
				...
				<form name = "frm" id = "frm">
					<input type = "hidden" value = "${board.getBoard_num() }" name = "comm_board">
					<div id = "comm_form">
						<table>
							<tr>
